...
export const PerfumeBoxSkeleton = (): ReactElement => {
  return (
    <div className="flex min-w-45 shrink-0 flex-col gap-3" aria-hidden="true">
      <div className="bg-surface border-stroke skeleton-shimmer relative flex h-45 w-full items-center justify-center rounded-2xl border p-3" />
