...
export type PerfumeWithRelations = Prisma.PerfumeGetPayload<{
  include: { decants: true; accords: { include: { accord: true } }; designer: true; season: true; timeOfDay: true; longevity: true; feeling: true; sillage: true; projection: true; notes: true };
}>;
